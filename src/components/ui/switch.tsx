...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none block h-5 w-5 rounded-full bg-background shadow-lg ring-0 transition-all ease-out duration-200 data-[state=checked]:translate-x-2.5 data-[state=unchecked]:translate-x-0 "
      )}
    />
  </SwitchPrimitives.Root>
))
