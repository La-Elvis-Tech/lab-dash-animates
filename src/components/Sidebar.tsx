      ...
      <div className={`p-6 border-b ${
        ...
        >
          <div className="flex items-center gap-4 min-w-0">
            ...
            <div 
              ref={logoTextRef}
              className={`transition-opacity duration-300 ${isCollapsed ? 'hidden' : 'block'} overflow-hidden`}
            >
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <div className={`menu-icon p-2 rounded-lg flex-shrink-0 ${
                      isActive 
                        ? theme === 'dark'
                          ? 'bg-gray-700/40'
                          : 'bg-gray-300/40'
                    ...
                    {!isCollapsed && (
                      <span className="menu-text font-medium text-sm whitespace-nowrap overflow-hidden">
                        {item.label}
                      </span>
                    )}
