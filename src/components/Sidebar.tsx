...
const Sidebar: React.FC<SidebarProps> = ({ isCollapsed, toggleSidebar }) => {
  ...
  return (
    <div 
      ref={contentRef} 
      className="sidebar-content h-screen bg-white dark:bg-neutral-900 border-r border-gray-200 dark:border-gray-700 flex flex-col transition-all overflow-hidden"
