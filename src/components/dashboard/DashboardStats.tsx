  ...
  return (
    <div className="grid grid-cols-2 gap-3 sm:gap-4 pb-4">
      {stats.map((stat, index) => (
        <Card key={index} className="dashboard-card bg-gradient-to-br from-white to-gray-50 dark:from-neutral-900/80 dark:to-neutral-950/80 border-neutral-300/60 border-opacity-80 dark:border-neutral-700 dark:border-opacity-20">
