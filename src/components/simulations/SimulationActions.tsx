      ...
      <CardContent className="space-y-4 pt-6">
        ...
        <div className="grid grid-cols-1 gap-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            <Button variant="outline" onClick={onSaveScenario} className="border-neutral-300 dark:border-neutral-600">
              <Save className="mr-2 h-4 w-4" />
              Salvar
            </Button>
            <Button variant="outline" onClick={onExportResults} className="border-neutral-300 dark:border-neutral-600">
