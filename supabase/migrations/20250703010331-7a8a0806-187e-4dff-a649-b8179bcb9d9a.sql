...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_appointments_scheduled_date_unit 
ON appointments(scheduled_date, unit_id) WHERE status != 'Cancelado';

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_appointments_status_unit_date 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_inventory_movements_date_item 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_profiles_status_unit 
