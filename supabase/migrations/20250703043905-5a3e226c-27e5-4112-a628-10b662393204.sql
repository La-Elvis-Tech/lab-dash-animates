-- Criar tabelas para sistema de chat persistente
...
CREATE TABLE public.chat_messages (
  ...
  sender TEXT NOT NULL CHECK (sender IN ('user', 'elvinho')),
  message_type TEXT DEFAULT 'normal' CHECK (message_type IN ('normal', 'command')),
  created_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()
);
